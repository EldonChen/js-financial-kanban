...
#### 1.2 实现 DirectAdapter（直接调用后端） ⏳ 待开始
- **任务描述**：实现直接调用后端服务的适配器
- **完成标准**：
...
#### 1.7 配置环境变量和 Runtime Config ⏳ 待开始
...
#### 2.1 创建 Playground 主页面（服务选择） ⏳ 待开始
